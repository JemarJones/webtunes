...
var a=this,t=albums[$(a).data("albumnum")]
console.log(t)
for(var e="https://open.spotify.com/embed/album/"+t[0].album_id,r=0;r<t.length;r++)$("#trackList").append('<li class="track hover" data-id="'+t[r].track_id+'"data-title="'+t[r].title+'"data-artist="'+t[r].artist+'" data-num='+r+'><img class="trkImg" src="../images/play_button.png"/>  '+t[r].title+" - "+t[r].artist+"</li>")
